...
Do not generate the Next.js app until Phase 4 is approved. The actual `create-next-app`
scaffold + dependencies happen then, not during the Phase 0 monorepo skeleton.
